...
export const toggleChatPanel = win => {
  toggleLayout(win, 'showChatPanel')
}
...
export const loadViewCommands = commandManager => {
  ...
  commandManager.add(COMMANDS.VIEW_TOGGLE_CHAT_PANEL, toggleChatPanel)
  ...
  for (const key in changes) {
    ...
    switch (key) {
      ...
      case 'showTabBar':
        ...
        break
      case 'showChatPanel':
        changeMenuByName('chatPanelMenuItem', value)
        break
      case 'sourceCode':
